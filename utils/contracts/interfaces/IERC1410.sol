...
interface IERC1410 {
//
//    /// @notice A descriptive name for mocks in this contract
//    function name() external view returns (string _name);
//
//    /// @notice An abbreviated name for mocks in this contract
//    function symbol() external view returns (string _symbol);
//
//    /// @notice Count all mocks tracked by this contract
//    /// @return A count of all mocks tracked by this contract
//    function totalSupply() external view returns (uint256);
    ...
    /// @param _amount The amount of mocks to transfer from `_tranche`
    /// @param _data Additional data attached to the transfer of mocks
    /// @return bool
    function sendTranche(bytes32 _tranche, address _to, uint256 _amount, bytes _data) external returns (bool);

    /// @notice Transfers the ownership of mocks from a specified tranche from one address to another address
    /// @param _tranche The tranche from which to transfer mocks
    /// @param _from The address from which to transfer mocks from
    /// @param _to The address to which to transfer mocks to
    /// @param _amount The amount of mocks to transfer from `_tranche`
    /// @param _data Additional data attached to the transfer of mocks
    /// @return bool
    function operatorSendTranche(bytes32 _tranche, address _from, address _to, uint256 _amount, bytes _data) external returns (bool);
...
//    function defaultOperatorsTranche(bytes32 _tranche) external view returns (address[]);
    ...
    /// @param _data Additional data attached to the minting of mocks
    /// @return A reason code related to the success of the mint operation
    function mint(bytes32 _tranche, address _owner, uint256 _amount, bytes _data) external returns (bool);
    ...
    /// @param _data Additional data attached to the burning of mocks
    /// @return A reason code related to the success of the burn operation
    function burn(bytes32 _tranche, address _owner, uint256 _amount, bytes _data) external returns (bool);
